...
fun day19(input: String): Day = sequence {
    val example = """
...
//    val (rawTowels, rawPatterns) = example.split("\n\n")
    val (rawTowels, rawPatterns) = input.split("\n\n")
...
private fun countArrangements(towels: List<String>, pattern: String): Long = when (pattern) {
    "" -> 1
